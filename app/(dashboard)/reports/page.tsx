...
const reports = [
  ...
  },
  {
    ...
    description:
      "Records due for disposal and retention schedule compliance",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Memo and workflow processing times and bottlenecks",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Tracking report for physical record locations and movements",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    title: "User Activity",
    description:
      "Login history, active users, and role-based activity summary",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    <div className="p-4 sm:p-6 space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {reports.map((report) => (
          ...
          >
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center mb-3 ${report.color}`}
            >
              {report.icon}
            </div>
