...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Casefolders", href: "/records/casefolders" },
      { label: "Classification", href: "/records/classification" },
      { label: "Retention", href: "/records/retention" },
      { label: "Physical Records", href: "/records/physical" },
      { label: "Disposition", href: "/records/disposition" },
      { label: "Auto Capture", href: "/records/capture" },
    ],
  },
  {
    label: "Search",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Form Designer", href: "/forms/designer" },
    ],
  },
  {
    label: "Reports",
